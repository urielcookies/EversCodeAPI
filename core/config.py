...
class Settings(BaseSettings):
    ...
    ATS_DAILY_LIMIT_FREE: int = 20            # Max ATS resume generations per day for free users
    ATS_DAILY_LIMIT_PAID: int = 10            # Max ATS resume generations per day for paid users
